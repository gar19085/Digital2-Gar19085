...
void setup() {
  ...
  //LCD_Bitmap(100,100, 11, 12, proyectil);
 pinMode(P1, INPUT_PULLUP);
 pinMode(P2, INPUT_PULLUP);
  /*
  for(int y = 50; y <92; y++){
    LCD_Bitmap(100,y, 25, 21, enemy_s);
    for(int x = 50; x <100; x++){
        LCD_Bitmap(x,y, 25, 21, enemy_s);
        x+=25;}
    y+=21;}
 L=100;
 */
...
void loop() {
    ...
    pushb2 (val_P2);
    Serial.println(l);
    //LCD_Print(text, 125, 100, 1520, 0xFF,0x00);
